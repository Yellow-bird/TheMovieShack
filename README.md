# TheMovieShack
***************
*  Single-page web application, part of teamwork assignement for Telerik Academy (Javascript apps course)
...
Design and implement an **object-oriented web application (SPA)** by choice.
